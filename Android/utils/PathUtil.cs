...
namespace Android
{
    class PathUtil
    {
        ...
        public static string adb_path = app_path + "bin//adb//adb.exe";

        public static string aapt_path = app_path + "bin//adb//aapt.exe";

        public static string unzip_path = app_path + "bin//adb//unzip.exe";
    }
}
